                ...
                <div className=" flex xl:flex-row  flex-col max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden  md:px-8">
                    <div className="flex-none space-y-5 px-4 sm:max-w-lg md:px-0 lg:max-w-xl">
                        ...
                        <div className="items-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                            ...
                            <a href="contact" className="flex items-center max-w-48 justify-center gap-x-2 py-2 px-4 text-gray-700 hover:text-gray-500 font-medium duration-150 active:bg-gray-100 border rounded-lg md:inline-flex">
                                Get contact
              ...
              <section className=" p-0">
                ...
                <div className=" flex flex-col-reverse max-w-screen-xl mx-auto text-gray-600 gap-x-12 items-center justify-between overflow-hidden  md:px-8">
                    <div className="flex-none space-y-5  md:mt-0 mt-10 px-4 sm:max-w-lg md:px-0 lg:max-w-3xl">
                        ...
                        <p className={`sm:text-[18px] text-gray-500  text-[10px]sm:leading-[36.8px] leading-[30.8px] font-poppins font-normal max-w-3xl`}>
                           MoDreams Pharmaceuticals is a private limited company that is currently selling pharmaceutical supplies for wholesalers and retailers. The company started functioning since 2019 G.C
                        </p>
                        <h2 className="text-2xl text-gray-800 font-semibold md:text-3xl">
                           our mission
                        </h2>
                        <p className={`sm:text-[18px] text-gray-500  text-[10px]sm:leading-[36.8px] leading-[30.8px] font-poppins font-normal max-w-3xl`}>
                           MoDreams Pharmaceuticals is a private limited company that is currently selling pharmaceutical supplies for wholesalers and retailers. The company started functioning since 2019 G.C
                        is a private limited company that is currently selling pharmaceutical supplies for wholesalers and retailers. The company started functioning since 2019 G.C</p>
                       
                        <div className="items-center gap-x-3 space-y-3 sm:flex sm:space-y-0">
                            {/* <a href="javascript:void(0)" className="block py-2 px-4 text-center text-white font-medium bg-indigo-600 duration-150 hover:bg-indigo-500 active:bg-indigo-700 rounded-lg shadow-lg hover:shadow-none">
                                Let's get started
                            </a> */}
                            <a href="contact" className="flex max-w-48 items-center justify-center gap-x-2 py-2 px-4 text-gray-700 hover:text-gray-500 font-medium duration-150 active:bg-gray-100 border rounded-lg md:inline-flex">
                                Get contact
                                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 text-blue-500 h-5">
                                    <path fillRule="evenodd" d="M2 10a.75.75 0 01.75-.75h12.59l-2.1-1.95a.75.75 0 111.02-1.1l3.5 3.25a.75.75 0 010 1.1l-3.5 3.25a.75.75 0 11-1.02-1.1l2.1-1.95H2.75A.75.75 0 012 10z" clipRule="evenodd" />
                                </svg>
